---
name: notify
description: Send a Discord notification to the user. Use this when the user says "ping me", "notify me", "send me a notification", or invokes /notify.
argument-hint: [message]
allowed-tools: [Bash]
---

Send a Discord notification via webhook. Compose a concise message summarizing what just completed or what the user should know, then run:
